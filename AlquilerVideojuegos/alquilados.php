...
<html>
    ...
    <body>
        <div class="container">
            ...
            $alquileres = AlquilerControlador::recuperarAlquilados();
            if($alquileres==null){
             ?>
       <div class="alert alert-warning">
                         No existe ningún juego alquilado en este momento
                    </div>  
            <?php
            }else{
            ...
            <tbody>
                ...
                <?php  
                    ...
                    foreach ($alquileres as $valor){                        
                        ...
                        $cliente= ClienteControlador::buscarClienteAlquilado($valor->dni_cliente);    
                        echo "<tr class=''>";
