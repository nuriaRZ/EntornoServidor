...
if(isset($_POST['borrar'])){
    JuegoControlador::borrarJuego($_POST['borrar']);
}
            ...
            <tbody>
                ...
                <?php  
                    ...
                    foreach ($juegos as $valor){ 
                        echo "<tr class=''>";
                       echo "<td><a href='descripcionJuego.php?codigo=".$valor->codigo."'><img src=".$valor->imagen." width='60px' height='60px'></a></td>" ;
                       ...
                       ?>                       
                           <form action="editarJuego.php" method="post">
                               <button type="submit" class="btn btn-outline-primary" name="editar" value="<?php echo $valor->codigo ?>">Editar</button>
                                </form>                           
                       ...
                       ?>  
                            <form action="" method="post">
                                <button type="submit" class="btn btn-danger" name="borrar" value="<?php echo $valor->codigo ?>">Borrar</button>
                                </form>
                       <?php
                       echo "</td>";
